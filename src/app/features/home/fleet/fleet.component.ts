...
const DEFAULT_FLEET: FleetVehicle[] = [
  { name: 'Pickup Truck', image: 'https://images.unsplash.com/photo-1687226675098-82bfca59e5ba?auto=format&fit=crop&w=900&q=80', description: 'Our most-used vehicle for house shifting and small loads — quick, versatile and easy to load.', capacity: 'Up to 1.5 Tons', order: 0 },
  ...
  { name: 'Open Truck', image: 'https://images.unsplash.com/photo-1626446644149-92e5039b74f0?auto=format&fit=crop&w=900&q=80', description: 'Versatile transport for general and bulk cargo.', capacity: 'Up to 18 Tons', order: 2 },
  { name: 'Car Carrier', image: 'https://images.unsplash.com/photo-1686966933735-305bd8fe0a77?auto=format&fit=crop&w=900&q=80', description: 'Safe, damage-free loading for car and vehicle transport.', capacity: 'Up to 4 Vehicles', order: 3 },
  ...
  { name: 'Flatbed Truck', image: 'https://images.unsplash.com/photo-1618906460527-05607b30f84b?auto=format&fit=crop&w=900&q=80', description: 'Suited for oversized and irregular cargo.', capacity: 'Up to 20 Tons', order: 7 },
